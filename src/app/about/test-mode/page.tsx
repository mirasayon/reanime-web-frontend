    ...
    return (
        <main className="flex items-baseline justify-center  p-6">
            <div className="max-w-7xl w-full rounded-2xl p-8 md:p-12">
                ...
                <section className="mt-6 text-gray-700 dark:text-gray-100 whitespace-pre-line">{DESCRIPTION}</section>
                <br />
                <section>
                    <strong>Есть вероятность частичной или полной потери данных пользователей с базы данных.</strong>
                </section>
                <section>
                    <p>Что это значит для вас:</p>
                    <ul className="mt-4 list-disc pl-6 space-y-2">
                        <li>Комментарии, аватары и профильные данные могут исчезнуть навсегда или отобразиться некорректно.</li>
                        <li>Мы рекомендуем не размещать важную или личную информацию в комментариях и профиле.</li>
                        <li>Если вы хотите помочь тестированию — пожалуйста, сообщайте найденные баги:</li>
                    </ul>
                </section>
