...
export function RequireLoginNotice() {
    const [showNotice, setShowNotice] = useState(false); // нажали «Смотреть»
    return (
        <div className={`p-3 ${BORDER}`}>
            ...
            <div className="flex items-start gap-4" hidden={!showNotice}>
                ...
                <div className="flex-1">
                    ...
                    <p className="mt-2 text-sm ">
                        Чтобы защитить контент и пользователей, мы показываем плеер только авторизованным пользователям.
                        Регистрация бесплатна, занимает пару секунд и сохраняет только логин и пароль.
                    </p>
                    <span className="mt-2 text-sm">
                        Защита от автоматических сканеров и жалоб — меньше шансов потерять сайт из-за возможного бана.
                    </span>
