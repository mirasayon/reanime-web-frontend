        ...
        >
            ...
            <div className="text-xs grid gap-2">
                        ...
                        {!hideIpAddress && (
                            <div>
                                <button
                                    onClick={(e) => {
                                        e.preventDefault();
                                        return setHideIpAddress(true);
                                    }}
                                    className="p-1 border-2 rounded border-slate-500 cursor-pointer"
                                >
                                    Скрыть
                                </button>
                            </div>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div>{s.ip_country ? s.ip_country : "неизвестно"}</div>
                </div>
                <div>
