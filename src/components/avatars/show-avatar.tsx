...
export function ShowAvatar({ avatar, userServiceBaseUrl }: { avatar: string; userServiceBaseUrl: string }) {
    const url = userServiceBaseUrl + "/v1/profile/avatar/view/" + avatar;
    return (
