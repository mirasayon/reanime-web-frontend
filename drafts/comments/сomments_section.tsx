                        ...
                        return (
                            <div key={item.commentdata.id} className="m-2 grid p-2 items-center">
                                <div className=" flex items-center">
                                    <Link className="flex items-center" href={`/user/${user.username}`}>
                                        <img
                                            src={
                                                user?.avatar_image
                                    ...
                                    <span className="p-2 font-semibold  "> {user.name || user.username}</span>

                                    {current_user && current_user.id === item.commentdata.ownerId && (
