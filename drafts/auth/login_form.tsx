 ...
 * 	<div className="p-10 flex-row justify-evenly flex ">
			...
			<form action={Action_handler} className="border-4 border-blue-500/50 rounded-lg p-8 flex text-xl flex-col m-4 ">
				<div className={`w-full ${is_dark ? "text-slate-300 " : "text-slate-800 "}font-mono font-bold flex-col flex items-center`}>
					С возращением!
					</div>
