...
import { liked_list_f, plan_list_f, viewed_list_f, watch_list_f } from "#/components/animes/options/user_list_server";

export async function Add_to_plan_list_element({ p_shiki_id, userP }: { p_shiki_id: number; userP: User }) {
    ...
    return (
        <>
            <form action={action_for_plan_list} className="flex">
                ...
                <input value={init?.id} type="text" name="alreadyhasid" id="alreadyhasid" readOnly hidden />
...
export async function Add_to_viewed_list_element({ p_shiki_id, userP }: { p_shiki_id: number; userP: User }) {
...
export async function Add_to_watch_list_element({ p_shiki_id, userP }: { p_shiki_id: number; userP: User }) {
...
export async function Add_to_liked_list_element({ p_shiki_id, userP }: { p_shiki_id: number; userP: User }): Promise<React.JSX.Element> {
